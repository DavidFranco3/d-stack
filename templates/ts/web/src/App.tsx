    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <nav className="premium-container flex justify-between items-center py-6 backdrop-blur-md sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-outfit font-bold text-xl tracking-tight">GravityStack TS</span>
        </div>
      ...
      <main className="premium-container pt-20 pb-32">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl mb-6 gradient-text">
            Build Faster with <br /> GravityStack TS
          </motion.h1>

          <motion.p variants={itemVariants} className="text-lg md:text-xl text-white/50 mb-12 leading-relaxed">
            A premium fullstack monolith template with TypeScript. 
            Type safety from client to server. Crafted for excellence.
          </motion.p>
        ...
        >
          {[
            { icon: <Server className="text-blue-400" />, title: "TS Express Backend", desc: "Type-safe API core with shared models and strict validation." },
            { icon: <Layout className="text-purple-400" />, title: "React + TS", desc: "Clean components with strong typing and Vite-accelerated dev." },
            { icon: <Shield className="text-green-400" />, title: "Enterprise Ready", desc: "Built-in support for complex architectures and shared types." }
          ].map((feature, i) => (
        ...
        >
          <div>
            <h2 className="text-2xl mb-2">Backend Connection (TS)</h2>
